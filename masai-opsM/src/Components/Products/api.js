...
export const getProducts = (page=1,sortBy="asc",limit=5) => {

  return fetch(`https://dbioz2ek0e.execute-api.ap-south-1.amazonaws.com/mockapi/get-products?page=${page}&limit=${limit}&orderBy=${sortBy}`)
  .then((res)=>res.json())
  .then((res)=>res)
  .catch((err)=>err)
